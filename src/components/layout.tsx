...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <Provider store={store}>
      <Box>
        <nav className=" bg-gray-50 fixed top-0 z-50 w-full  border-b border-gray-200">
          <div className="px-3 py-3 lg:px-5 lg:pl-3 bg-gray-50">
            <div className="flex items-center justify-between bg-gray-50">
              <div className="flex items-center justify-start rtl:justify-end bg-gray-50">
                <button
        ...
        <div className="p-4 sm:ml-64 bg-gray-50">{children}</div>
      </Box>
    </Provider>
  );
}
